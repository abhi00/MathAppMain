...
a=Math.sqrt(ar/6.18182);
peri=9*a;

String out ="Calculating side via Area: a =sqrt(ar/6.18182)\n a = "+a+"\n Calculating  Perimeter  via Area : peri=9*a\n peri="+peri;
...
a=peri/9;
ar=6.18182*Math.pow(a, 2);

String out ="Calculating side via Peri: a =peri/9 \n a = "+a+"\n Calculating Area via Perimeter  : ar=6.18182*pow(a,2)\n ar="+ar;
